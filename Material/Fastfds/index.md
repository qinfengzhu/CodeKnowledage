...
1. [Fastdfs简介](FastDFS介绍.ppt)

2. 与其他文件系统对比

![对比](images/与其他文件系统对比.jpg)

3. 部署视图

普通公司安装
![普通公司安装](images/基本部署图.png)

小公司安装
![小公司安装](images/小公司部署图.png)

4. 具体安装

[Fastfds具体安装](install.md)

安装参考资料 [顺利安装的步骤](https://www.jianshu.com/p/1c71ae024e5e), [带有错误的一步步安装](https://blog.csdn.net/xiatiancc/article/details/83819062)

#### `Tracker` 配置 , `port = 22122` 与`store_group = group2 ` 与 `storage_ids_filename = storage_ids.conf`

==文件 cp /etc/fdfs/tracker.conf.sample /etc/fdfs/tracker.conf
```
